...
const runPuppeteer = async (url) => {
  ...
  const result = dom.window.document.querySelectorAll("dom.window.document.querySelectorAll(".EntityList.EntityList--Standard.EntityList--Regular.EntityList--ListItemRegularAd")"); // do tuda radi kako treba, neznam sta tu treeba hvatat
  console.log(result);
